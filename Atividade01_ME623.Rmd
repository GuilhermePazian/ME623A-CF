...
Substituindo os valores na estatística de teste escolhida, obtemos a um um nível de significância de *0.05*:
...
Temos uma probabilidade de **$`r p.valor`$** de se obter uma estatística de teste igual ou mais extrema que a que observamos na amostra, sob a hipótese nula.
